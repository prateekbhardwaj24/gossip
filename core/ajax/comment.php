...
if(isset($_POST['comment'])){
    ...
    $commentid = $loadFromUser->create('comments', array('commentBy'=>$userid, 'comment_parent_id' => $postid, 'comment'=>$comment_text, 'commentOn'=>$postid, 'sender'=>$profileid, 'reciever'=>$userid, 'commentAt' => date('Y-m-d H:i:s')));

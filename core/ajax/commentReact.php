...
if(isset($_POST['commentid'])){
    ...
    $loadFromUser->create('react', array('reactBy'=>$userid, 'reactOn'=>$postid, 'reactCommentOn'=>$commentid, 'reactType'=>$reactType, 'sender'=> $userid, 'reciever'=>$profileid, 'reactTimeOn'=>date('Y-m-d H:i:s')));
    

    if($profileid != $userid){

     $loadFromUser->create('notification',array('sender'=>$userid, 'receiver' => $profileid, 'postid' => $postid, 'status'=> '0', 'notificationOn'=>date('Y-m-d H:i:s'), 'status'=>0));
    }

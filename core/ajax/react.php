...
$profileid = $_POST['profileid'];
   ...
   $loadFromUser->delete('react', array('reactBy'=>$user_id, 'reactOn' => $postid, 'reactCommentOn' => '0', 'reactReplyOn'=>'0'));

    $loadFromUser->create('react', array('reactBy'=>$user_id, 'reactOn' => $postid, 'reactType' => $reactType, 'sender'=> $profileid, 'reciever'=>$userid, 'reactTimeOn'=>date('Y-m-d H:i:s'), 'status'=>0));

...
if(isset($_POST['commentid'])){
    ...
    $loadFromUser->create('react', array('sender' => $userid, 'reactOn' => $postid, 'reactCommentOn'=>$commentid, 'reactReplyOn'=>$commentparentid, 'reactType'=>$reactType, 'reactBy'=>$userid, 'reciever'=>$profileid, 'reactTimeOn' =>date('Y-m-d H:i:s'), 'status'=>0));

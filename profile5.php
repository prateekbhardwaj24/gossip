...
<body  onload="myFunction()" style="margin:0; overflow: scroll;  background: #f2f7fb;">
	...
	<script>
		$(function() {
			...
			$(document).on('click', '.block-show', function() {
				...
				$.post('http://localhost/mychat4/core/ajax/block.php', {
					profileid: profileid,
					userid: userid
				}, function(data) {
					location.reload();
			...
			var BASE_URL = "http://localhost/mychat4/";

			function notificationUpdate(userid) {
				$.post('http://localhost/mychat4/core/ajax/notify.php', {
			...
			$(document).on('change', '#profile-upload', function() {
				...
				if (name != '') {
					$.post('http://localhost/mychat4/core/ajax/profilePhoto.php', {
						imgName: imgName,
						userid: userid
					}, function(data) {
						// $('#adv_dem').html(/data);
					...
					$.ajax({
						url: 'http://localhost/mychat4/core/ajax/profilePhoto.php',
						cache: false,
						contentType: false,
						processData: false,
						data: form_data,
			...
			$('#cover-upload').on('change', function() {
				...
				if (name != '') {
					$.post('http://localhost/mychat4/core/ajax/profile5.php', {
						imgName: imgName,
						userid: userid
					}, function(data) {
						// alert(data);
				...
				$.ajax({
					url: 'http://localhost/mychat4/core/ajax/profile5.php',
					cache: false,
					contentType: false,
					processData: false,
					data: form_data,
			...
			$('.status-share-button').on('click', function() {
				...
				if (files.length != 0) {
					...
					if (error_images == '') {
						$.ajax({
							url: 'http://localhost/mychat4/core/ajax/uploadPostImage.php',
							method: "POST",
							data: formData,
							contentType: false,
							cache: false,
							...
							beforeSend: function() {
								...
								$('#uploading').html("</br><label>Uploading....</label>");
							},
							success: function(data) {
								$('#loading').html(data);
								$('#sortable').empty();
				...
				if (stIm == '') {
					$.post('http://localhost/mychat4/core/ajax/postSubmit.php', {
			...
			$(document).on('click', '.postImage', function() {
				...
				$.post('http://localhost/mychat4/core/ajax/imgFetchShow.php', {
					fetchImgInfo: userid,
					postid: postid,
					imageSrc: imageSrc
				}, function(data) {
					...
					$('.comment-submit').keyup(function(e) {
						if (e.keyCode == 13) {
							...
							if (comment == '') {
								...
								$.ajax({
									type: "POST",
									url: "http://localhost/mychat4/core/ajax/comment.php",
									data: {
										comment: comment,
										userid: userid,
										postid: postid,
			...
			$(document).on('click', '.post-option', function() {
				...
				$(postDetails).show().html('<div class="post-option-details"><ul><li class="post-edit" data-postid="' + postid + '" data-userid="' + userid + '">Edit</li><li class="post-delete" data-postid="' + postid + '" data-userid="' + userid + '">Delete</li></ul></div>');
			})
			...
			$(document).on('click', '.edit-post-save', function() {
				...
				$.post('http://localhost/mychat4/core/ajax/editPost.php', {
			...
			function mainReactSubmit(typeR, postId, userId, nf_3) {
				var profileid = p_id;
				$.post('http://localhost/mychat4/core/ajax/react.php', {
					reactType: typeR,
					postId: postId,
					userId: userId,
					profileid: profileid
			...
			$('.like-action-wrap').hover(function() {
				...
				$(mainReact).html(' <div class="react-bundle align-middle" style="position:absolute;margin-top: -98px; margin-left: -15px;  background-color:white;padding: 0 2px;border-radius: 25px; box-shadow: 0px 0px 5px black; height:100px; width:180px; justify-content:space-around; transition: 0.3s; display:flex; flex-direction:column;"><div style="display:flex; background-color:white;padding: 0 2px; margin-bottom:10px; height:30px; width:175px; justify-content:space-around; border-radius:20px;transition: 0.3s;"> <div class="like-react-click align-middle"> <img class="main-icon-css" src="' + BASE_URL + 'assets/image/react/like.png " alt=""></div> <div class="love-react-click align-middle"> <img class="main-icon-css" src="' + BASE_URL + 'assets/image/react/love.png " alt=""></div> <div class="haha-react-click align-middle"> <img class="main-icon-css" src="' + BASE_URL + 'assets/image/react/haha.png " alt=""></div></div> <div style="display:flex; border-radius:20px; background-color:white;padding: 0 2px; height:30px; width:175px; justify-content:space-around; transition: 0.3s;"> <div class="wow-react-click align-middle"> <img class="main-icon-css" src="' + BASE_URL + 'assets/image/react/wow.png " alt=""></div> <div class="sad-react-click align-middle"> <img class="main-icon-css" src="' + BASE_URL + 'assets/image/react/sad.png " alt=""></div> <div class="angry-react-click align-middle"> <img class="main-icon-css" src="' + BASE_URL + 'assets/image/react/angry.png " alt=""></div></div> </div>');
			}, function() {
				var mainReact = $(this).find('.react-bundle-wrap');
				$(mainReact).html('');
			})
...
//			})
			...
			function comReactSubmit(typeR, postid, userid, commentID, com_nf_3) {
				...
				$.post('http://localhost/mychat4/core/ajax/commentReact.php', {
						commentid: commentID,
						reactType: typeR,
						postid: postid,
						userid: userid,
			...
			$(document).on('click', '.edit-com-save', function() {
				...
				var editedTextVal = $(editedText).val();
				$.post('http://localhost/mychat4/core/ajax/editComment.php', {
					postid: postid,
					userid: userid,
					editedTextVal: editedTextVal,
					commentid: commentid
				...
				$('input.reply-input-style.reply-submit').keyup(function(e) {
					if (e.keyCode == 13) {
						...
						if (comment == '') {
							...
							$.ajax({
								type: "POST",
								url: "http://localhost/mychat4/core/ajax/reply.php",
								data: {
			...
			function replyReactSubmit(typeR, postid, userid, commentID, commentparentid, com_nf_3) {
				var profileid = p_id;
				$.post('http://localhost/mychat4/core/ajax/replyReact.php', {
					commentid: commentID,
					reactType: typeR,
					postid: postid,
					userid: userid,
			...
			$(document).on('click', '.edit-reply-save', function() {
				...
				$.post('http://localhost/mychat4/core/ajax/editReply.php', {
					postid: postid,
					userid: userid,
					editedTextVal: editedTextVal,
					commentid: commentid,
			...
			$(document).on('click', '.post-Share', function() {
				...
				$.post('http://localhost/mychat4/core/ajax/share.php', {
					shareText: shareText,
					profileid: profileid,
					postid: postid,
					userid: userid
			...
			$(document).on('click', '.share-container', function() {
				...
				window.location.href = "http://localhost/mychat4/profile5.php?username=" + userLink + "";
			})
			$(document).on('click', '.shared-post-option', function() {
				...
				$(postDetails).show().html('<div class="shared-post-option-details"><ul style="padding:0;"><li class="shared-post-edit" data-postid="' + postid + '" data-userid="' + userid + '">Edit</li><li class="shared-post-delete" data-postid="' + postid + '" data-userid="' + userid + '">Delete</li></ul></div>');
			})
			...
			$(document).on('click', '.shared-edit-post-save', function() {
				...
				var editedTextVal = $(editedText).val();
				$.post('http://localhost/mychat4/core/ajax/sharedEditPost.php', {
					sharedPostid: postid,
					userid: userid,
					editedTextVal: editedTextVal
				}, function(data) {
			...
			// $('.search-result').empty();
			// } else {
			// $.post('http://localhost/mychat4/core/ajax/search.php', {
			...
			//				var profileid = $(this).data('profileid');
			//
			//				$.post('http://localhost/mychat4/core/ajax/request.php', {
			//					request: profileid,
			//					userid: userid
			//				}, function(data) {
			//
